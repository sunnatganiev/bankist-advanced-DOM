...
// ------------- SELECTIONG, CREATING AND DELETING -------
...
// --------------------- EVENT DELEGATION: EMPLEMENTING PAGE NAVIGATION -----
...
// const h1arr = [...h1.parentElement.children]

// h1arr.forEach(function (el) {
//   if (el !== h1) {
...
//   if (scrollY > initialCoords.top) nav.classList.add('sticky')
...
const slider = function () {
  ...
  // slider.style.transform = 'scale(.2) translateX(-1000px)'
